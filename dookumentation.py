...
def stealth_to_string(stringy):
    ...
    return zlib.decompress(base64.b64decode(__i2b(_n))).decode('utf-8').strip()
...
def json_meta_to_html(json_meta):
    ...
    html = Templar(stealth_to_string(HTML))  # give it template string,render
...
def json_meta_to_md(json_meta):
    ...
    md = Templar(stealth_to_string(MD)) # give it template string,then render
